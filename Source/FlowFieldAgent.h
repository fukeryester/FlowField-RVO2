...
#include "FlowField.h"
#include "FlowFieldAgent.generated.h"
...
class FLOWFIELDTEST_API AFlowFieldAgent : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    void SetFlowField(AFlowField* NewFlowField);
    ...
    UFUNCTION(BlueprintCallable, Category = "RVO2")
    TArray<AFlowFieldAgent*> GetNearbyAgents() const;

    UFUNCTION(BlueprintCallable, Category = "RVO2")
    FVelocityObstacle ComputeVelocityObstacle(const AFlowFieldAgent* OtherAgent) const;
