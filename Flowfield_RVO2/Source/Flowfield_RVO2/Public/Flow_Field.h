...
#include "Flow_Field.generated.h"
...
struct FFlowFieldCell
{
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "FlowField Cell")
...
class FLOWFIELD_RVO2_API AFlow_Field : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FlowField Settings")
    TSubclassOf<AFlow_Field_Agent> FlowFieldAgentClass;
